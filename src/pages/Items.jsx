            ...
            <div className={`min-h-screen pt-20 transition-colors duration-300 ${
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                    <div className="animate-pulse">
                        <div className={`h-8 rounded w-48 mb-8 transition-colors duration-300 ${
                            currentTheme === 'dark' ? 'bg-gray-700' : 'bg-gray-300'
                        }`}></div>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                            {[...Array(8)].map((_, i) => (
                                <div key={i} className={`h-80 rounded-xl transition-colors duration-300 ${
                                    currentTheme === 'dark' ? 'bg-gray-700' : 'bg-gray-300'
                                }`}></div>
                            ))}
                        </div>
        ...
        <div className={`min-h-screen pt-20 transition-colors duration-300 ${
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="mb-8">
                    ...
                    }`}>Discover amazing items shared by your community</p>
                </div>
                
                {/* Test Items Button */}
                <button
                    onClick={() => addTestItems(user)}
                    className="mb-4 bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700 transition-colors duration-300"
                    disabled={!user}
                >
                    {user ? "Add Test Items" : "Sign In to Add Test Items"}
                </button>
                    ...
                    <div className="flex flex-col lg:flex-row gap-4">
                        ...
                        <div className="flex-1 relative">
                            ...
                            <input
                                ...
                                className={`w-full pl-12 pr-4 py-3 border rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-300 ${
                                    currentTheme === 'dark'
                        ...
                        <div className="flex items-center gap-3">
                            <select
                                ...
                                className={`px-4 py-3 border rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-colors duration-300 ${
                                    currentTheme === 'dark'
                            ...
                            <button
                                ...
                                className={`flex items-center gap-2 px-4 py-3 border rounded-xl transition-colors duration-300 ${
                                    currentTheme === 'dark'
                                ...
                                >
                                    ...
                                    <button
                                        ...
                                        className={`rounded-full p-0.5 transition-colors duration-300 ${
                                            currentTheme === 'dark' ? 'hover:bg-blue-800/50' : 'hover:bg-blue-100'
                                        }`}
                                    >
                                        <X size={14} />
                                    </button>
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="hidden md:flex items-center gap-2">
                            <div className={`flex items-center gap-1 px-3 py-1 rounded-full text-sm transition-colors duration-300 ${
                                currentTheme === 'dark'
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex items-center gap-2">
                            <ArrowUpDown size={16} className={`transition-colors duration-300 ${
                                currentTheme === 'dark' ? 'text-gray-500' : 'text-gray-400'
                            }`} />
                            <select
                                value={sortBy}
                                onChange={(e) => setSortBy(e.target.value)}
                                className={`px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 text-sm transition-colors duration-300 ${
                                    currentTheme === 'dark'
                                        ? 'bg-gray-700 border-gray-600 text-gray-100'
                                        : 'bg-white border-gray-200 text-gray-900'
                                }`}
                ...
                {filteredItems.length === 0 ? (
                    <div className="text-center py-16">
                        <div className="max-w-md mx-auto">
                            <Package size={64} className={`mx-auto mb-4 transition-colors duration-300 ${
                        ...
                        {hasMore && (
                            <div className="text-center mt-12">
                                <button
                                    ...
                                    className={`border px-8 py-3 rounded-xl transition-colors duration-300 shadow-sm disabled:opacity-50 flex items-center gap-2 mx-auto ${
                                        currentTheme === 'dark'
            ...
            {isFilterOpen && (
                <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
                    <div className={`rounded-2xl shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto transition-colors duration-300 ${
                        currentTheme === 'dark' ? 'bg-gray-800' : 'bg-white'
                    }`}>
                        <div className={`sticky top-0 border-b px-6 py-4 rounded-t-2xl transition-colors duration-300 ${
                            currentTheme === 'dark' 
                                ? 'bg-gray-800 border-gray-700' 
                                : 'bg-white border-gray-100'
                        }`}>
                        ...
                        <div className="p-6 space-y-6">
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                    {["all", ...conditions].map(condition => (
                                        <button
                                            ...
                                            className={`p-3 text-left border rounded-xl transition-colors duration-300 ${
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-colors duration-300 ${
                                                currentTheme === 'dark'
                                                    ? 'bg-gray-700 border-gray-600 text-gray-100'
                                                    : 'bg-white border-gray-200 text-gray-900'
                                            }`}
                            ...
                            <div className={`flex gap-3 pt-4 border-t transition-colors duration-300 ${
                                ...
                                <button
                                    onClick={clearAllFilters}
                                    className={`flex-1 px-4 py-3 border rounded-xl transition-colors duration-300 ${
                                        currentTheme === 'dark'
                                            ? 'border-gray-600 text-gray-300 hover:bg-gray-700'
                                            : 'border-gray-200 text-gray-700 hover:bg-gray-50'
                                    }`}
